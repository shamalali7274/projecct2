...
/// شريط الإجراءات أسفل صفحة التسميع (العادي والسبر الذكي معاً): غير
/// مقبول / مقبول / إلغاء — بشكل الأزرار الدائرية المطابق للتصميم
/// المرجعي، مبني من CircleIconButton الموحّد بدل تكرار كود الزر ثلاث
/// مرات. كل زر يفتح نفس نافذة التأكيد الموحّدة (ConfirmActionDialog)
/// باسم مناسب لكل إجراء.
///
/// "إلغاء" هون بسيط: تأكيد ثم onCancelled() - كل صفحة (تسميع عادي أو
/// سبر ذكي) بتقرر شو بالضبط يعني "إلغاء" عندها (بالتسميع العادي:
/// إغلاق بدون حذف - الجلسة تضل upcoming وقابلة للاستئناف. بالسبر
/// الذكي: حذف صامت للجلسة - ما إلها داعي تظهر بالسجل إذا ما تقرر
/// مصيرها بعد).
